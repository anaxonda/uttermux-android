...
class AdaptiveBufferController(private val settings:AppSettings) {
    private var rtfEwma=0.6;private var samples=0;private var underruns=0
    ...
    fun snapshot()="rtf=${"%.2f".format(rtfEwma)}, startup=${startupMillis()}ms, underruns=$underruns"
}
