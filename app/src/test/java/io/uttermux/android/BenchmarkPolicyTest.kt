...
class BenchmarkPolicyTest {
    @Test fun standardCandidatesNeverExceedFourOrAvailableCores(){assertEquals(listOf(1),BenchmarkPolicy.threadCandidates(1));assertEquals(listOf(1,2,3,4),BenchmarkPolicy.threadCandidates(12))}
